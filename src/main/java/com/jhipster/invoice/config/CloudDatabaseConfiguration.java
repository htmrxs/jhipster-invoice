package com.jhipster.invoice.config;
...
@Configuration
@EnableMongoRepositories("com.jhipster.invoice.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.jhipster.invoice.config.dbmigrations");
